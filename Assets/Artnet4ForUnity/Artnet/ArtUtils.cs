...
namespace ArtnetForUnity
{
    ...
    public static class ArtUtils
    {
        ...
        public static ArtnetSettings LoadSettings()
        {
            ...
            */
            string DataLocation = Application.streamingAssetsPath + "/ArtnetSettings.json";
        ...
        public static bool GetDhcp()
        {
            try
            {
                ...
                {
                    bool dynamicSetting = SelectedInterface.GetIPProperties().GetIPv4Properties().IsDhcpEnabled;
            ...
            catch (Exception e)
            {
                //Console.WriteLine(e);
                //throw;
                Debug.LogError("[ARTUTIL] error while attempted to retreive DHCP status :"+e.Message );
                return false;
            }
