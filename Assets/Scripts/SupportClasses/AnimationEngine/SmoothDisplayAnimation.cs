...
{
    public class SmoothDisplayAnimation
    {
        ...
        public void Update()
        {
            ...
            float animationLengthBuffer = 1.0f;
            int animationLengthBuffer_i = Convert.ToInt32(Math.Floor(animationLengthBuffer));
            //unsafe
            //{
                for (int i = 0; i < 3; ++i)
                {
                    if (posnAnimationActive[i])
                    {
                        ...
                        else
                        {
                            ...
                            {
                                //posn[i] = targetPosnAnim[i].GetAnimatedValue(posnAnimationLength[i] * animationLengthBuffer_i); // set to end value
                    ...
                    if (rotnAnimationActive[i])
                    {
                        ...
                        else
                        {
                            ...
                            {
                                //rotn[i] = targetRotnAnim[i].GetAnimatedValue(rotnAnimationLength[i] * animationLengthBuffer_i); // set to end value
                ...
                if (scaleAnimationActive)
                {
                    ...
                    else
                    {
                        ...
                        {
                            scale = targetScaleAnim.GetAnimatedValue(scaleAnimationLength * animationLengthBuffer_i); // set to end value
                            //scale = targetScaleAnim.
                ...
                if (alphaAnimationActive)
                {
                    ...
                    else
                    {
                        ...
                        {
                            //alpha = targetAlphaAnim.GetAnimatedValue(alphaAnimationLength * animationLengthBuffer_i); // set to end value
