...
{
    public class GeneralPurposeDisplayAnimation
    {
        ...
        private AEEaseInExpoOneStage[] targetPosnAnim = new AEEaseInExpoOneStage[3]; // x, y, and z
        ...
        public GeneralPurposeDisplayAnimation()
        {
            ...
            for (i = 0; i < 3; ++i)
            {
                ...
                posn[i] = 0.0f;
                targetPosn[i] = 0.0f;
                targetPosnAnim[i] = new AEEaseInExpoOneStage();
        ...
        #region set new values and start animations
        ...
        #endregion set new values and start animations
        ...
        public void Update()
        {
            ...
            float animationLengthBuffer = 1.05f;
            //unsafe
            //{
                for (int i = 0; i < 3; ++i)
                {
