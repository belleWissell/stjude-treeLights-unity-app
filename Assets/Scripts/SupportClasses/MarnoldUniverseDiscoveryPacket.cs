...
{
    public class MarnoldUniverseDiscoveryPacket : MarnoldSacnPacket
    {
        ...
        public override int Length => RootLayer.Length + UniverseDiscoveryPacketFramingLayer.Length + UniverseDiscoveryLayer.Length;
         ...
         public MarnoldUniverseDiscoveryPacket()
        {
        ...
        public static MarnoldUniverseDiscoveryPacket Parse(ReadOnlySpan<byte> bytes, RootLayer rootLayer, UniverseDiscoveryPacketFramingLayer framingLayer)
        {
            MarnoldUniverseDiscoveryPacket dataPacket = new MarnoldUniverseDiscoveryPacket
            {
                RootLayer = rootLayer,
